...
export default function MuzeInput(props: MuzeInputProps) {
  return (
    <div className='flex flex-col'>
      ...
      <input
        id='mzinput'
        className='rounded-full px-2.5 py-1 outline-none border-2 border-transparent focus:border-neutral-700 ring-neutral-50 bg-neutral-800 text-neutral-50 shadow-md shadow-neutral-900'
